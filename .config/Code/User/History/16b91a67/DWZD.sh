...
# I have removed the '-p' (prompt) and '-i' (case-insensitive) flags as they are not needed without an input bar.
choice=$(echo -e "$options" | rofi -dmenu -theme ~/.config/rofi/themes/catppuccin-mocha.rasi)
