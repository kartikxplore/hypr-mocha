...
if response.status_code == 200:
    ...
    for clinic in clinics:
        ...
        website_tag = soup.find_all('a', class_="track-visit-website")
        phone_tag = soup.find_all('div', class_="phones")
        ...
        print(f"Name: {name}, Website: {website_link}, Phone: {phone_number}")
